...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida whereMarca($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida wherePreco($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida whereValidade($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida whereTipo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida whereSabor($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida whereDtEntrada($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Comida>|Comida query()
